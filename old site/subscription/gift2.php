...
<title>Gift A Subscription</title>
<style type="text/css">
<!--
.style5	{
	color:#2f4e9d;
...
//Others
	...
	var gphone = document.getElementById("g_phone").value;
	var gemail = document.getElementById("g_email").value;
	...
	if (gname ==""){alert ("Enter Your Name");}
		else if (gphone ==""){alert ("Enter your phone number");}
			else if(IsNumeric(gphone)===false) {alert("Please enter numeric value for your mobile number");} 
				else if(gphone.length != 10) {alert("Please enter a correct 10-digit pincode number.");}
					else if(gphone.charAt(0) == 0 || gphone.charAt(0) == "" || gphone.charAt(0) == 1 || gphone.charAt(0) == 2 || gphone.charAt(0) == 3 || gphone.charAt(0) == 4 || gphone.charAt(0) == 5 || gphone.charAt(0) == 6) { alert("Please enter a correct 10-digit contact number starting with 7 , 8 or 9");}	
						else if (gemail ==""){alert ("Enter your email address");}
							else if (isEmail(gemail) == false){alert("Please enter your E-mail address correctly ")}	
	
	else if (uid ==""){alert ("Enter a User ID");}
...
<table width="1080" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="10"><img src="images/top3.jpg" width="1080" height="942">
      <div id="layer-form">
        <form  name="ite" id="ite"  method="post" action="form_process.php">		
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="40" colspan="2" align="center" valign="middle" class="title">Please Enter the message or greeting you want to convey </td>
            </tr>
            <tr>
              <td height="30" colspan="2" align="center" valign="middle" class="style1"><table width="600" border="0" cellpadding="0" cellspacing="0" class="tbl2">
                 <tr>
                   ...
                   <td width="362" height="10" align="left"></td>
                 </tr>
            <tr>
              <td height="30" colspan="2" align="center" valign="middle" class="text"><textarea name="g_mesg" cols="40" rows="4" class="style5" id="g_mesg"></textarea>
                <input name="gift" type="hidden" id="gift" value="yes">
                <input name="logged" type="hidden" id="logged" value="yes"></td>
              </tr>
            <tr>
              <td height="10" align="right" valign="middle" class="text">&nbsp;</td>
