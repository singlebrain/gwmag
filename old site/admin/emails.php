...
<table width="868" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="878" height="30" valign="top"><a href="javascript:history.back()">&lt;&lt;Back</a></td>
  </tr>
</table>
<table width="868" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  <tr>
    <td width="936"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        ...
        <td width="245" bgcolor="#F3F3F3" class="style2">Email Address </td>
        </tr>
	  <?php 
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" class="style2"><a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a></td>
        </tr>
	  <?php } ?>
    </table></td>
  </tr>
