...
//$qu3 = "SELECT * FROM  user_details ORDER BY reg_date";	
...
//$user_details_order_regdt = mysql_query($qu3, $db) or die(mysql_error($db));	

$sub = mysql_query($qs1, $db) or die(mysql_error($db));	
$sub_order_id = mysql_query($qs2, $db) or die(mysql_error($db));	
