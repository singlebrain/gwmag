...
<div class="w3-main" style="margin-left:200px">
  ...
  <!-- opacity -->
    ...
    <!-- <div class="w3-section w3-bottombar w3-padding-16"> -->
      ...
      <button  onclick="document.getElementById('id01').style.display='block'" class=" w3-cell w3-button w3-container "><i class="fa fa-user-plus w3-margin-right"></i>RENEW</button>
    </div>
    <!-- </div> -->
  </header>
<!-- slider -->
