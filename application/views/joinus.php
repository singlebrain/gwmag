...
<nav class="w3-sidebar w3-collapse w3-animate-left" style=" background-color:#f2f2f2; z-index:3;width:200px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="javascript:void(0)" onclick="window.location='loadjoinus'" class="w3-bar-item w3-text-teal w3-button w3-padding w3-hover-blue"><i class="fa fa-users fa-fw w3-margin-right"></i>JOIN US</a>
  </div>
...
<!-- about -->
<div class="w3-content w3-display-container" style="max-width:100%; " >
  <img class="w3-image w3-animate-right" src="<?php echo base_url('images/join us.jpg') ?>" style="width:100%">
  </div>
  <!-- Footer -->
