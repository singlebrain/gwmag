...
<nav class="w3-sidebar w3-collapse w3-animate-left" style=" background-color:#f2f2f2; z-index:3;width:200px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="javascript:void(0)" onclick="window.location='loadsayso'" class="w3-bar-item w3-button w3-text-teal w3-padding w3-hover-blue"><i class="fa fa-user fa fa-comment w3-margin-right"></i>SAY SO</a>
...
<div class="w3-main" style="margin-left:200px">
 ...
 <div>
 <img src="<?php echo base_url('images/endorse/01.jpg') ?>" style="width:100%">
 </div>
<div>
<img src="<?php echo base_url('images/endorse/02.jpg') ?>" style="width:100%">
 </div>
 <div>
 <img src="<?php echo base_url('images/endorse/03.jpg') ?>" style="width:100%">
 </div>
