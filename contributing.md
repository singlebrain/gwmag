# Contributing to GWMAG


GWMAG is a community driven project and accepts contributions of code and documentation from the community. These contributions are made in the form of Issues or [Pull Requests]
...
GWMAG as it uses CodeIgnitor recommends PHP 5.4 or newer to be used, but it should be
...
GWMAG uses the [Git-Flow](http://nvie.com/posts/a-successful-git-branching-model/) branching model which requires all pull requests to be sent to the "develop" branch. This is
...
2. Go to the GWMAG repo
3. Fork it
4. Clone your GWMAG repo: git@github.com:<your-name>/gwmag.git
...
1. `git remote add gwmag https://github.com/singlebrain/gwmag.git`
2. `git pull gwmag develop`
